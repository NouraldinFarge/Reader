...
| Markup script or remote tracking          | DOMPurify first pass, narrower Reader allowlist, URL classifier, no remote resources    | Live/reloaded mutation-XSS corpus, dialog/popup/request assertions          |
